...
class AnaYemekPage extends StatelessWidget {
  final List<Yemek> yemekler = [
    Yemek(name: 'Çiftlik Kebabı', imagePath: 'images/ciftlikkebabı.jpg'),
    Yemek(name: 'Pilav', imagePath: 'images/pilav.jpg'),
    Yemek(name: 'Taze Fasülye', imagePath: 'images/tazefasülye.jpg'),
  ];
  AnaYemekPage({super.key});
